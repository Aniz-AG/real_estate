...
// All Indian states and union territories, for state <select> dropdowns.
...
// Looks up the state for a known city name (case-insensitive). Returns null
// for cities not in the curated list (smaller towns, localities, etc.) so
// callers can leave the state field as-is rather than clearing it.
