...
const Navbar = () => {
    ...
    const timer = setTimeout(async () => {
      try {
        ...
        const res = await fetch(
          `/api/cities?query=${encodeURIComponent(query)}&limit=60`,
          {
  ...
  const buyMenuData = {
    popularChoices: [
      {
        label: "Ready to Move",
        href: "/browse?possessionStatus=ready_to_move",
      },
      { label: "Owner Properties", href: "/browse?postedBy=owner" },
      { label: "Budget Homes", href: "/browse?maxPrice=5000000" },
      { label: "Premium Homes", href: "/browse?minPrice=15000000" },
      { label: "New Projects", href: "/new-projects", highlight: true },
    ],
    propertyTypes: [
      { label: "Flats/Apartments", href: "/browse?type=flat,apartment" },
      {
        label: "House/Villa",
        href: "/browse?type=house,villa,residential_house",
      },
      { label: "Plot", href: "/browse?type=plot,land" },
      {
        label: "Office Space",
        href: "/browse?category=commercial&type=office_space",
      },
      { label: "Commercial Space", href: "/browse?category=commercial" },
    ],
    budget: [
      { label: "Under ₹50 Lac", href: "/browse?maxPrice=5000000" },
      {
        label: "₹50 Lac - ₹1 Cr",
        href: "/browse?minPrice=5000000&maxPrice=10000000",
      },
      {
        label: "₹1 Cr - ₹1.5 Cr",
        href: "/browse?minPrice=10000000&maxPrice=15000000",
      },
    ...
    <>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative hidden md:block">
                ...
                >
                  ...
                  {selectedCity}
                  <ChevronDown
                    className={`h-4 w-4 transition-transform ${activeDropdown === "city" ? "rotate-180" : ""}`}
                  />
                </button>
            ...
            <div className="hidden lg:flex items-center space-x-1">
              ...
              <div className="relative">
                ...
                >
                  Buy
                  <ChevronDown
                    className={`h-4 w-4 transition-transform ${activeDropdown === "buy" ? "rotate-180" : ""}`}
                  />
                </button>
                        ...
                        {buyMenuData.popularChoices.map((item, i) => (
                          <li key={i}>
                            ...
                            >
                              {item.label}
                              {item.highlight && (
                                <span className="ml-1 text-xs bg-[#FFF3E0] text-[#E65100] px-1.5 py-0.5 rounded">
                                  New
                                </span>
                              )}
                            </Link>
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown
                    className={`h-4 w-4 transition-transform ${activeDropdown === "login" ? "rotate-180" : ""}`}
                  />
                </button>
              ...
              {/* Post Property Button - Admin Only */}
      ...
      {isMobileMenuOpen && (
        <>
          ...
          />
          <div className="lg:hidden fixed left-0 top-0 bottom-0 z-50 w-80 max-w-[85vw] bg-white shadow-2xl overflow-y-auto">
