                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="e.g., Beautiful 3BHK Flat in Prime Location"
                    />
                  </div>
                  <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      >
                        {FORM_OPTIONS.propertyCategories.map((opt) => (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 border rounded-md"
                      >
                        {FORM_OPTIONS.postedByType.map((opt) => (
                          <option key={opt.value} value={opt.value}>
                            {opt.label}
                          </option>
                        ))}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      >
                        ...
                        {FORM_OPTIONS.possessionStatus.map((opt) => (
                          <option key={opt.value} value={opt.value}>
                            {opt.label}
                          </option>
                        ))}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      >
                        ...
                        {FORM_OPTIONS.ownership.map((opt) => (
                          <option key={opt.value} value={opt.value}>
                            {opt.label}
                          </option>
                        ))}
                    ...
                    <div>
                      ...
                      >
                        ...
                        {FORM_OPTIONS.furnishing.map((opt) => (
                          <option key={opt.value} value={opt.value}>
                            {opt.label}
                          </option>
                        ))}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      >
                        ...
                        {FORM_OPTIONS.propertyAge.map((opt) => (
                          <option key={opt.value} value={opt.value}>
                            {opt.label}
                          </option>
                        ))}
                  ...
                  <div className="flex flex-wrap gap-4 pt-4">
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        id="isTopProject"
                        name="isTopProject"
                        checked={formData.isTopProject}
                        onChange={handleInputChange}
                        className="w-4 h-4"
                      />
                      <Label htmlFor="isTopProject" className="cursor-pointer">
                        Top Project
                      </Label>
                    </div>
                    <div className="flex items-center gap-2">
