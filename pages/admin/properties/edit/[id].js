    ...
    try {
      ...
      setFormData({
        ...
        possession_date: property.possession_date
          ? new Date(property.possession_date).toISOString().slice(0, 10)
          : "",
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        name="is_top_project"
                        type="checkbox"
                        checked={formData.is_top_project}
                        onChange={handleChange}
                        className="h-4 w-4"
                      />
