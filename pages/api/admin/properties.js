  ...
  try {
    ...
    form.parse(req, async (err, fields, files) => {
      ...
      property.description =
        getValue(fields.description) || property.description;
      property.property_category =
        getValue(fields.property_category) || property.property_category;
      property.property_type =
        getValue(fields.property_type) || property.property_type;
      ...
      property.address = {
        property_address:
          getValue(fields.property_address) ||
      ...
      property.property_age =
        getValue(fields.property_age) || property.property_age;
      ...
      property.posted_by_type =
        getValue(fields.posted_by_type) || property.posted_by_type;
      ...
      const isProject = parseBool(fields.is_project);
      if (isProject !== undefined) property.is_project = isProject;
