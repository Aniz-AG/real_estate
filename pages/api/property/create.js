...
async function handler(req, res) {
  ...
  try {
    ...
    const property = await Property.create({
      ...
      covered_area: getField("coveredArea")
        ? Number(getField("coveredArea"))
        : undefined,
      carpet_area: getField("carpetArea")
        ? Number(getField("carpetArea"))
        : undefined,
      plot_area: getField("plotArea")
        ? Number(getField("plotArea"))
        : undefined,
      ...
      possession_date: getField("possessionDate")
        ? new Date(getField("possessionDate"))
        : undefined,
      status: "available",
      ...
      is_project: getField("isProject") === "true",
